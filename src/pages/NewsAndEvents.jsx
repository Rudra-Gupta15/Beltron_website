...
const NewsAndEvents = () => {
  ...
  const filteredData = newsAndEventsData.filter(item =>
      ...
      <div className="bg-[#f1f5f9] py-6 px-4 border-b border-gray-200">
        <div className="max-w-[90rem] mx-auto px-4 md:px-6">
          <div className="flex items-center gap-2 text-[14px] text-gray-500 mb-6 font-medium">
            ...
            <span className="text-[#0F4BB8]">News & Events</span>
          </div>
            ...
            <table className="w-full text-left border-collapse border border-gray-300 min-w-[800px]">
              <thead>
                <tr className="bg-[#f8f9fa] border-b border-gray-300 text-[#1C2F57] text-[14px]">
                  ...
                  <th className="p-3 font-bold border border-gray-300">Headline</th>
                  <th className="p-3 font-bold border border-gray-300 w-[150px]">News/Event Status</th>
                ...
                {paginatedData.length === 0 && (
                  <tr>
                    <td colSpan="4" className="p-8 text-center text-gray-500 border border-gray-300">
                      No news & events found matching your search.
                    </td>
                  </tr>
                )}
              </tbody>
